  ...
  for (var i = 0; i < 4; i++) {
    for (var j = 0; j < 4; j++) {
      ...
      if(props.pixelUtil.pixelDict[(-i - 6) + "," + 7 + "," + (-j + adjstmnt)] == undefined){
        ...
        props.pixelUtil.opacityDict[(-i - 6) + "," + 7 + "," + (-j + adjstmnt)] = 0;
      }
  ...
  for (var i = 0; i < 4; i++) {
    for (var j = 0; j < 12; j++) {
      ...
      if(props.pixelUtil.pixelDict[(-5) + "," + (-j + 6) + "," + (-i + adjstmnt)] == undefined){
        ...
        props.pixelUtil.opacityDict[(-5) + "," + (-j + 6) + "," + (-i + adjstmnt)] = 0;
      }
  ...
  for (var i = 0; i < 4; i++) {
    for (var j = 0; j < 12; j++) {
      ...
      if(props.pixelUtil.pixelDict[(-10) + "," + (-j + 6) + "," + (-i + adjstmnt)] == undefined){
        ...
        props.pixelUtil.opacityDict[(-10) + "," + (-j + 6) + "," + (-i + adjstmnt)] = 0;
      }
  ...
  for (var i = 0; i < 4; i++) {
    for (var j = 0; j < 4; j++) {
      ...
      if(props.pixelUtil.pixelDict[(-i - 6) + "," + (-6) + "," + (-j + adjstmnt)] == undefined){
        ...
        props.pixelUtil.opacityDict[(-i - 6) + "," + (-6) + "," + (-j + adjstmnt)] = 0;
      }
